...
def create_jobs():
    ...
    module_path = (
        "scripts.snellius.single_synapse_learning_extended.alignment_and_SNR.run"
    )
    ...
    seed = 1234 * 5432  # Random seed for reproducibility
    num_iterations = 1
    for i in range(num_iterations):
        seed += (
            123 * 321
        )  # Pick a new seed for each iteration to ensure different random sequences
