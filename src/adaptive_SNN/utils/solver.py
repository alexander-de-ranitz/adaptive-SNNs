...
def run_SNN_simulation(terms: AbstractTerm, solver: Euler, t0: float, t1: float, dt0: float, y0: PyTree, save_every_n_steps: int = 1, args: PyTree = None):
    """
    ...
    Args:
        terms (AbstractTerm): The terms defining the differential equation.
